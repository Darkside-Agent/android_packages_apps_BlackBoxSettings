package com.blackbox.settings.preferences;
...
import com.blackbox.settings.BlackBoxSettings;
import com.blackbox.settings.preferences.ColorPickerDialog.OnColorChangedListener;
...
public class ColorPickerPreference extends Preference implements OnPreferenceClickListener, OnColorChangedListener {
    ...
    protected void showDialog(Bundle state) {
        if (mDialog == null || !mDialog.isShowing()) {
            ...
            BlackBoxSettings.lockCurrentOrientation((SettingsActivity) getContext());
